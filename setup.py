...
setup(
    ...
    scripts=['ratd/scripts/robust.py','ratd/scripts/robust-profiles.py','ratd/scripts/robust-watchdog.py','ratd/scripts/robust-search.py','ratd/scripts/robust-convict.py'],
